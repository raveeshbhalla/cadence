...
export const Gear = ({ size = 16 }: { size?: number }) => (
  <Svg size={size} stroke="currentColor" sw={1.8}>
...
export const SignOutIcon = ({ size = 15 }: { size?: number }) => (
  <Svg size={size} stroke="currentColor" sw={1.9}>
